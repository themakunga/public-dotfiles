...
M.plugin = function()
  ...
  -- Carga tu archivo de tema personalizado (asegúrate de que la ruta coincida con tu estructura)
  local ok_theme, lualine_theme = pcall(require, 'plugins.editor.lualine-theme')
  if not ok_theme then
    vim.notify('[CHECK REQUIRE FAILED] plugins.editor.lualine-theme ' .. debug.getinfo(2).source, vim.log.levels.WARN)
    return
  end
