...
-- M.plugin = function()
--   vim.pack.add({
--     { src = 'https://github.com/Isrothy/neominimap.nvim', version = "v3.15.4", name = "Neominimap" },
--   })
--
--   ---@module 'neominimap'
--   local ok, neominimap = pcall(require, 'Neominimap')
--
--   if not ok then
--     vim.notify("[CHECK REQUIRE FAILED] neominimap " .. debug.getinfo(2).source, vim.log.levels.WARN)
--     return
--   end
--
--
...
--     handlers = {},
--   }
--   vim.keymap.set('n', '<leader>mt', function() neominimap.api.toggle() end, { desc = "Neominimap Toggle" })
-- end
--
-- return M
